...
vim.keymap.set('v', 'p', '"_dP', opts, { desc = "After yanking with 'y' and pasting over a selection, the copied text is retained in the clipboard and not over written with the text that was paster over." })
